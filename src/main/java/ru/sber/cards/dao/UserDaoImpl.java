...
public class UserDaoImpl implements UserDao {
    ...
    private static final String INSERT_USER_SQL = "INSERT INTO USER" +
            ...
            " (default , ?, ?, ?);";
    private static final String CHEK_LOGIN = "SELECT * FROM USER WHERE LOGIN=?;";
    ...
    public void saveNewUser(User user) {
        try (Connection connection = H2DataBase.getConnection();
            ...
            H2DataBase.printSQLException(e);
        }
    }

    @Override
    public boolean loginChek(LoginRequest loginRequest) {
        try (Connection connection = H2DataBase.getConnection();
    ...
    public void setLoginTrue(LoginRequest loginRequest) {
        try (Connection connection = H2DataBase.getConnection();
            ...
            System.out.println("Ошибка при изменении состояния");
        }
    }
